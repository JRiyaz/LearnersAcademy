	...
	<div class="container">
		...
		<div class="fluid-container">
			<div class="px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
				...
				<p class="lead mt-3">You can click on the following links to
					view the respective details.</p>
			</div>
			...
			<div class="accordion" id="classReport">
				...
				<div class="card">
					...
					<div id="overview" class="collapse show"
						aria-labelledby="headingOne" data-parent="#classReport">
						<div class="card-body">
							<div class="info text-right">
								<h5 class="card-title pricing-card-title text-info">
									Overview of ${cls.name }</h5>
								<strong class="text-muted my-4 d-block">This tab shows
									brief info about the class.</strong>
							</div>
				...
				<div class="card">
					...
					<div id="students" class="collapse" aria-labelledby="headingTwo"
						...
						<div class="card-body">
							<div class="info text-right">
								<h5 class="card-title pricing-card-title text-success">
									List of Students</h5>
								<strong class="text-muted my-4 d-block">This tab shows
									List of all Students belongs to this class.</strong>
							</div>
							<table class="table table-hover">
								<thead>
									<tr>
				...
				<div class="card">
					...
					<div id="subjectsTeachers" class="collapse"
						aria-labelledby="headingThree" data-parent="#classReport">
						<div class="card-body">
							<div class="info text-right">
								<h5 class="card-title pricing-card-title text-danger">List
									of Subjects and respective Teachers</h5>
								<strong class="text-muted my-4 d-block">This tab shows
									List of all Subjects and respective Teachers. Click on the Teacher name for more details.</strong>
							</div>
							<table class="table table-hover">
								<thead>
									<tr>
								...
								<tbody>
									<c:forEach begin="0" end="${cls.teachers.size() - 1}"
										...
										<tr>
											...
											<td><a href="teacher?teacherId=${cls.teachers[loop.index].teacherId }">${cls.teachers[loop.index].name }</a></td>
										</tr>
									</c:forEach>
								</tbody>
							</table>
					...
					<ul class="pagination justify-content-center">
						...
						<c:forEach begin="1" end="${pages }" varStatus="loop">
							<li
								...
								<a class="page-link" href="report?classId=${loop.index}">${loop.index}</a>
							</li>
						</c:forEach>

						<li class="page-item ${pages == currentPage ? 'disabled' : ''}">
							<a class="page-link" href="report?classId=${currentPage + 1}">Next</a>
						</li>
					</ul>
				</nav>
			</section>
